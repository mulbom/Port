				...
				<form action="insert.doPosting">
					<div class="ground">
						<ul>
							...
							<input type="text" class="title" placeholder="제목 입력하삼" id="TITLE" name="TITLE" />
						...
						<li class="newPost-li-file"><label for="fileUpload"></label> <input type="file" id="fileUpload" name="fileUpload" accept="image/*, video/*"></li>
					</div>
				</form>
			</main>
