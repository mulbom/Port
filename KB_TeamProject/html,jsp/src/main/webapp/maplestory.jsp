			...
			<main>
				<div class="container-fluid px-4">
					...
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item active">메이플스토리</li>
					</ol>
					<div class="card mb-4">
						...
						<div class="card-body">
							<table id="datatablesSimple">
								...
								<tbody>
									...
									%>
									<%
									if (boardInfo.get("tag").equals("메이플스토리")) {
									%>
									<tr onclick="location.href='detailPost.jsp?id=<%=boardInfo.get("id")%>'">
										...
										<td>
											<a href="detailPost.jsp?id=<%=boardInfo.get("id")%>"><%=boardInfo.get("title")%></a>
										</td>
										<td>
